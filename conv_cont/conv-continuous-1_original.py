...
class Conv(GraphScene):
    ...
    def draw_h_t(self, y0):
        ht = VGroup()
        h1 = Line([-8, y0, 0], [1, y0, 0])
        h1.set_color(BLUE)
        h2 = Line([1, y0, 0], [1, 1 + y0, 0])
        h2.set_color(BLUE)
        h3 = Line([1, 1 + y0, 0], [2, 1 + y0, 0])
        h3.set_color(BLUE)
        h4 = Line([2, 1 + y0, 0], [2, y0, 0])
        h4.set_color(BLUE)
        h5 = Line([2, y0, 0], [8, y0, 0])
        h5.set_color(BLUE)
    ...
    def ht_reflect(self,y0,ht, htau_text):
        ...
        hmtau = VGroup()
        hm1 = Line([-8, y0, 0], [-2, y0, 0])
        hm1.set_color(BLUE)
        hm2 = Line([-2, y0, 0], [-2, 1 + y0, 0])
        hm2.set_color(BLUE)
        hm3 = Line([-2, 1 + y0, 0], [-1, 1 + y0, 0])
        hm3.set_color(BLUE)
        hm4 = Line([-1, 1 + y0, 0], [-1, y0, 0])
        hm4.set_color(BLUE)
        hm5 = Line([-1, y0, 0], [8, y0, 0])
        hm5.set_color(BLUE)
    ...
    def moving_window_intro(self,y0,hmtau_text):
        ...
        inf_limit_text.move_to([-2, y0-0.6, 0])
        ...
        sup_limit_text.move_to([-1, y0-0.6, 0])
    ...
    def construct(self):
        ...
        # Pantalla Inicial
        self.titulo_credits("Convolución Contínua","Ejemplo 1","Ing Leandro Borgnino TSSL UNC 2023")
        ...
        # Arrow
        arr = Arrow([-1, y0 - 0.8, 0], [-1, y0 + 0.2, 0])
        self.play(Write(arr))
        window.add(arr)
        ...
        y1.set_color(ORANGE)
        y2 = Line([1, 0 + yz, 0], [2, 1 + yz, 0])
        y2.set_color(ORANGE)
        y3 = Line([2, 1 + yz, 0], [3, yz, 0])
        y3.set_color(ORANGE)
        y4 = Line([3, yz, 0], [6, yz, 0])
        y4.set_color(ORANGE)
        #
        #
        ## dots 1
        ...
        one = self.get_graph(lambda x: 1, x_min=0, x_max=1)
